...
// no.1
const newCountries = new Object(countries);
console.log(newCountries);
const language = countries.map((lang) => lang.languages);
console.log(language);
console.log(Object.values(countries.map((lang) => lang.languages)))
let sum = 0;
...
// no.2
// const set = new Set(newCountries);
